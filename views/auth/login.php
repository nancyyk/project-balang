...
<div class="min-h-screen flex items-center justify-center bg-white px-6">
    ...
    <div class="w-full max-w-md bg-white p-8 rounded-2xl shadow-md border border-purple-300">
        ...
        <h2 class="text-2xl font-semibold text-purple-700">Login</h2>
        <p class="text-sm text-gray-600 mt-1 font-medium">Masuk ke akun kamu</p>
        ...
        <p class="text-sm text-center text-gray-600 mt-6 font-medium">
            Belum punya akun?
            <a href="index.php?page=register" class="text-purple-700 font-semibold hover:text-purple-900">
                Register
            </a>
        </p>
